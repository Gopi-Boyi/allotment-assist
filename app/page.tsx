...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      {activePanel === 'university' && <section className="shell panel-page"><div className="panel-heading"><div><p className="section-label">OFFICIAL UNIVERSITY DETAILS</p><h2>About Aditya University</h2><p>Verified details to help you reach the right campus and prepare for MCA reporting.</p></div><a className="outline-btn" href="https://adityauniversity.in" target="_blank" rel="noreferrer">Open official website <ArrowRight size={16} /></a></div><div className="university-layout"><div className="campus-photo university-video" aria-label="Aditya University campus video"><iframe src="https://www.youtube-nocookie.com/embed/d4ViL61Tyqc?autoplay=1&mute=1&loop=1&playlist=d4ViL61Tyqc&controls=0&disablekb=1&fs=0&playsinline=1&rel=0&modestbranding=1" title="Aditya University campus video" allow="autoplay; encrypted-media" /><div className="university-video-shade" /><div className="photo-caption"><Building2 size={17} /><span>Aditya Nagar campus<br /><strong>Surampalem, Kakinada</strong></span></div></div><div className="university-details"><div className="detail-card"><MapPin size={18} /><div><p className="card-label">CAMPUS ADDRESS</p><p>Aditya Nagar, ADB Road,<br />Surampalem, Kakinada District,<br />Andhra Pradesh – 533437</p></div></div><div className="detail-card"><GraduationCap size={18} /><div><p className="card-label">MCA PROGRAMME</p><p><strong>Eligibility:</strong> Recognized 3 or 4-year bachelor&apos;s degree with Mathematics at 10+2 level.</p><p><strong>Tuition:</strong> Approximately ₹1,00,000 per year.</p></div></div><div className="detail-card"><Phone size={18} /><div><p className="card-label">ADMISSIONS HELPLINE</p><p><a href="tel:+919989776661">+91 9989 776661</a><br /><Mail size={13} className="inline-icon" /> <a href="mailto:info@adityauniversity.in">info@adityauniversity.in</a></p></div></div></div></div></section>}
