...
const documents = [
  ...
  { category: 'Academic Certificates', title: 'Joining Letter', note: 'Original + 2 photocopies', icon: FileText },
  { category: 'Academic Certificates', title: 'Allotment Order', note: 'Original + 2 photocopies', icon: ScrollText },
