    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      {activePanel === 'home' && <>
        ...
        <section className="shell feature-grid">
          ...
          <button className="feature-card feature-green" onClick={() => setActivePanel('navigation')}><span className="icon-box"><Navigation /></span><div><p className="card-label">03 · ON CAMPUS</p><h4>Find your way</h4><p>Block, floor, room and the person you need to meet.</p></div><ArrowRight className="card-arrow" /></button><button className="feature-card feature-white" onClick={() => setActivePanel('university')}><span className="icon-box"><Building2 /></span><div><p className="card-label">04 · OFFICIAL DETAILS</p><h4>About Aditya University</h4><p>Address, MCA eligibility, fee guidance and official contacts.</p></div><ArrowRight className="card-arrow" /></button><button className="feature-card feature-purple" onClick={() => setActivePanel('navigation')}><span className="icon-box"><Shirt /></span><div><p className="card-label">05 · AFTER ALLOTMENT</p><h4>Buy your uniform</h4><p>Purchase your official uniform from the campus store after your reporting slot is confirmed.</p><p className="card-meta"><strong>₹1,800</strong> · Cash or UPI accepted</p></div><ArrowRight className="card-arrow" /></button>
        </section>
      </>}
